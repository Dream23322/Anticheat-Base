let fast = true;
import * as fastMath from "./fastMaths.js";
import * as standardMath from "./ksmaths.js";

let math = null;

const initializeMath = () => {
  if (!math) {
    console.warn("[Anticheat] Loading Math")
    math = fast ? fastMath : standardMath;
    console.warn("[Anticheat] -> Loaded: " + (settings.performance.fastMath ? "Fast Math" : "Standard Math"));
  }
  return math;
};
